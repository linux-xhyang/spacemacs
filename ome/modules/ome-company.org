...
* 配置 company
  #+BEGIN_SRC emacs-lisp
    ...
    (defun ome-company/init-ycmd ()
      ...
      (with-eval-after-load 'company
        (spacemacs|add-company-backends :backends '(company-capf company-ycmd company-anaconda
                                                                 company-dabbrev-code company-files company-yasnippet)
                                        :mode c-mode-common)

        (spacemacs|add-company-backends :backends '(company-ycmd company-anaconda company-capf
                                                                 company-dabbrev-code company-files company-yasnippet)
                                        :mode python-mode)
