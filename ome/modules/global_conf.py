...
if (os.getenv('ANDROID_BUILD_TOP')):
  ...
  androidflags = [
    ...
    '-isystem', os.getenv('ANDROID_BUILD_TOP') + '/system/media/audio/include',
  ...
  android_root_dir = os.getenv('ANDROID_BUILD_TOP')
  kernelflags = []
  kernel_root_dir = []
  if (os.path.exists(os.path.join(android_root_dir, 'common'))):
    kernel_root_dir = os.path.join(android_root_dir, 'common')
  elif (os.path.exists(os.path.join(android_root_dir, 'kernel'))):
    kernel_root_dir = os.path.join(android_root_dir, 'kernel')
  elif (os.path.exists(os.path.join(android_root_dir, 'vendor/mstar/kernel'))):
  ...
  flags = flags + androidflags + kernelflags
else:
  flags = [
    '-Wall',
    '-Wextra',
